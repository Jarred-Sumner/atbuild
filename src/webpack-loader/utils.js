...
var CustomModule = /** @class */ (function (_super) {
    ...
    function CustomModule(mod, code) {
        ...
        _this = _super.call(this, __assign(__assign({}, mod), { type: ".js", request: mod.request + ".js", userRequest: mod.userRequest + ".js", loaders: loaders, generator: mod.generator, resolveOptions: mod.resolveOptions, parser: mod.parser })) || this;
        _this.code = code;
...
var AtBuildWebpackPlugin = /** @class */ (function () {
    ...
    AtBuildWebpackPlugin.prototype.apply = function (compiler) {
        ...
        compiler.hooks.compilation.tap("AtBuildWebpackPlugin", function (compilation, _a) {
            ...
            normalModuleFactory.hooks.module.tap("AtBuildPlugin", function (module, opts, arg2) {
